...
### Shared prompt
```text
Copilot CLI: copilot -p "Write a Python function named count_vowels(text: str) -> int that counts the vowels a, e, i, o, and u regardless of case. Do not count y. Return the total number of vowels in the string."

AntigravityCLI: agy -p "Write a Python function named count_vowels(text: str) -> int that counts the vowels a, e, i, o, and u regardless of case. Do not count y."
```
